...
function createGlyphVD(options) {
    ...
    // V termina em (300, 250). O topo do D (y=550) deve se conectar a este ponto.
    const xOffset = 300 - thickness; // d starts at x=thickness
    const yOffset = 250 - 550; // d's top is at 550
